...
describe('NavigationComponent', () => {
    ...
    describe('initialization', () => {
        ...
        it('should subscribe to router events on init', () => {
            vi.spyOn(router.events, 'subscribe');
            component.ngOnInit();
    ...
    describe('router integration', () => {
        it('should update activeLink when router URL changes', async () => {
            component.ngOnInit();
            await router.navigate(['/player-stats']).then(() => {
                expect(component.activeLink).toBe('/player-stats');
            });
        });

        it('should map the root route to player-stats for tab highlighting', async () => {
            component.ngOnInit();
        ...
        it('should update activeLink for goalie stats route', async () => {
            component.ngOnInit();
            await router.navigate(['/goalie-stats']).then(() => {
    ...
    describe('template rendering', () => {
        ...
        it('should activate link when clicked', () => {
            fixture.detectChanges();
            const compiled = fixture.nativeElement as HTMLElement;
            const link = compiled.querySelector('a[mat-tab-link]') as HTMLAnchorElement;
