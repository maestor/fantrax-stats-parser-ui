...
describe('MinGamesSliderComponent', () => {
    ...
    describe('ngOnInit - player context', () => {
        ...
        it('should update minGames when player filters change', () => {
            component.context = 'player';
            component.ngOnInit();
        ...
        it('should track multiple player filter updates', () => {
            component.context = 'player';
            component.ngOnInit();
    ...
    describe('ngOnInit - goalie context', () => {
        ...
        it('should update minGames when goalie filters change', () => {
            component.context = 'goalie';
            component.ngOnInit();
        ...
        it('should not be affected by player filter changes', () => {
            component.context = 'goalie';
            component.ngOnInit();
    ...
    describe('ngOnChanges', () => {
        ...
        it('should update minGames when maxGames decreases below it', () => {
            component.context = 'player';
        ...
        it('should handle maxGames equal to minGames', () => {
            component.minGames = 10;
            component.maxGames = 10;
    ...
    describe('onValueChange - player context', () => {
        ...
        it('should not affect goalie filters when context is player', () => {
            component.context = 'player';
    ...
    describe('onValueChange - goalie context', () => {
        ...
        it('should not affect player filters when context is goalie', () => {
            component.context = 'goalie';
    ...
    describe('edge cases', () => {
        it('should handle minGames of 0', () => {
            component.context = 'player';
        ...
        it('should handle large minGames values', () => {
            component.context = 'player';
        ...
        it('should handle rapid maxGames changes', () => {
    ...
    describe('integration scenarios', () => {
        it('should synchronize with filter service on init and update', () => {
            filterService.updatePlayerFilters({ minGames: 10 });
