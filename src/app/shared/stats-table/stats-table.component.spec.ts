...
describe('StatsTableComponent', () => {
    ...
    beforeEach(async () => {
        ...
        translate.setTranslation('fi', {
            a11y: {
                ...
                tableNavigationHint: 'Käytä ylös/alas näppäimiä selataksesi taulukkoa. PageUp/PageDown hyppää 10 riviä. Paina Enter tai välilyönti avataksesi pelaajakortin.',
            },
            table: {
    ...
    describe('focus management helpers', () => {
        ...
        it('focusRow should clamp index and focus/scroll the row element', () => {
            ...
            const focus0 = vi.spyOn(row0, 'focus');
            const focus1 = vi.spyOn(row1, 'focus');

            (row0 as any).scrollIntoView = vi.fn();
            (row1 as any).scrollIntoView = vi.fn();
    ...
    describe('selectItem', () => {
        it('should open dialog with PlayerCardComponent', () => {
            ...
            expect(dialog.open).toHaveBeenCalledWith(PlayerCardComponent, expect.objectContaining({
                maxWidth: '95vw',
                width: 'auto',
        ...
        it('should provide correct currentIndex in navigation context', () => {
            ...
            vi.spyOn(dialog, 'open').mockImplementation((_comp: any, config: any) => {
    ...
    describe('selectRow feature', () => {
        ...
        it('should use isRowSelected to determine checkbox state', () => {
            ...
            expect(component.isRowSelected(mockPlayerData[0])).toBe(true);
            expect(component.isRowSelected(mockPlayerData[1])).toBe(false);
        });
    });
