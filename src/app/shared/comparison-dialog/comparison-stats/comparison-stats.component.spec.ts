...
describe('ComparisonStatsComponent', () => {
    ...
    describe('player stats', () => {
        ...
        it('should bold the higher value', () => {
            ...
            expect(scoreRow.boldA).toBe(true);
            expect(scoreRow.boldB).toBe(false);
        });
        ...
        it('should bold Player B when they have higher value', () => {
            ...
            expect(hitsRow.boldA).toBe(false);
            expect(hitsRow.boldB).toBe(true);
        });
        ...
        it('should not bold either value when they are equal', () => {
            ...
            expect(goalsRow.boldA).toBe(false);
            expect(goalsRow.boldB).toBe(false);
        });
    });
    ...
    describe('goalie stats (season)', () => {
        ...
        it('should bold the LOWER gaa value (lower is better)', () => {
            ...
            expect(gaaRow.boldA).toBe(true);
            expect(gaaRow.boldB).toBe(false);
        });
        ...
        it('should bold higher savePercent (higher is better)', () => {
            ...
            expect(spRow.boldA).toBe(true);
            expect(spRow.boldB).toBe(false);
        });
    });
    ...
    describe('stat-highlight CSS class', () => {
        it('should apply stat-highlight class to the higher value element', () => {
            ...
            expect(valueA.classList.contains('stat-highlight')).toBe(true);
            expect(valueB.classList.contains('stat-highlight')).toBe(false);
        });
    });
